/* ! parallax.js v1.5.0 (http://pixelcog.github.io/parallax.js/) @copyright 2016
 * PixelCog, Inc. @license MIT
...
!function (t, i, e, s) {
    function o(i, e) {
        ...
        !this.imageSrc && this
            .$element
            .is("img") && (this.imageSrc = this.$element.attr("src"));
        var r = (this.position + "")
            .toLowerCase()
            .match(/\S+/g) || [];
        if (
            ...
            "top" != r[0] && "bottom" != r[0] && "left" != r[1] && "right" != r[1] || (r = [
                r[1], r[0]
            ]),
            ...
            return this.imageSrc && this.iosFix && !this
                .$element
                .is("img") && this
                .$element
                .css({
        ...
        if (navigator.userAgent.match(/(Android)/)) 
            return this.imageSrc && this.androidFix && !this
                .$element
                .is("img") && this
                .$element
                .css({
